...
$data=$data."<li><a href=\"project-detail-page.php?data=".$seminar_id."\"><img src="."default.jpg"."><div class=\"overlay\"><summary><h2>".$seminar_name."</h2><h3>".$seminar_place."</h3><h3>".$seminar_date."</h3></summary><div class=\"loves\"><span>".$seminar_audience."</span></div></div></a></li>";
